  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    <a href="index.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      ...
      <span class="fs-4">Codex</span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="index.php" class="nav-link text-white  <?php if ($page=='snippets') {
            echo 'active';
                                                        } ?>" <?php if ($page=='snippets') {
      ...
      <li>
        <a href="projects.php" class="nav-link text-white <?php if ($page=='projects') {
            echo 'active';
      ...
      <li>
        <a href="categories.php" class="nav-link text-white <?php if ($page=='categories') {
            echo 'active';
    ...
    <div class="dropdown">
      <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="https://github.com/deparagon.png" alt="" width="32" height="32" class="rounded-circle me-2">
        <strong>Mr</strong>
      </a>
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
        <li><a class="dropdown-item" href="projects.php">New project...</a></li>
        <li><a class="dropdown-item" href="categories.php">Categories</a></li>
        <li><a class="dropdown-item" href="#">Profile</a></li>
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item" href="https://mrparagon.me">Site</a></li>
      </ul>
    </div>
  </div>
