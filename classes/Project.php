...
class Project extends ModelBoss
{
    public $id;
    public $name;
    public $description;
    ...
    public function view()
    {
        ...
        $html = '<form method="post" class="form_for_object_update_add" data-action="update" data-object="Snip">
      ...
      <div class="card">
            ...
            <div class="modal-footer">
              <button data-action="update" data-object="Project" class="btn_for_object_update_add btn btn-lg btn-primary">Save</button>
            </div>
           </form>';
    ...
    public function search($info)
    {
        ...
        if (!empty($data)) {
            foreach ($data as $code) {
                $listdata .= '<tr> <td> '.$code->name.' </td> <td> '.$code->description.'</td> <td>'.$code->created_at.' </td>  <td> <button data-action="view" data-object="Project" class="view_action_process btn btn-xs btn-success" data-id="'. $code->id.'">view</button>  </td> <td> <button data-action="delete" data-object="Project" class="delete_action_process btn btn-xs btn-danger" data-id="'. $code->id.'">delete</button>  </td>  </tr>';
            }
        } else {
            $listdata .= '<tr> <td colspan="5"> No project found   </td>  </tr>';
        }
